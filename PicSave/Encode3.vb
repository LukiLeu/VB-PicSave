...
Module Encode3
    'Backgoundworker
    Public WithEvents Encode3 As New BackgroundWorker
    Dim Erfolg_Enc3 As Boolean = False
    Private Declare Auto Function SetProcessWorkingSetSize Lib "kernel32.dll" (ByVal procHandle As IntPtr, ByVal min As Int32, ByVal max As Int32) As Boolean

    Public Function GetTheNextGGT(ByVal Color As Long, ByVal Mod2 As Long, ByVal Mod3 As Long, ByVal Mod5 As Long) As Long
...
#Region "BackGroundWorker Events"
    Public Sub Encode3_DoWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles Encode3.DoWork
        Dim img As Bitmap
            ...
            For f = 0 To 7
                ...
                Select Case Color
                    ...
                    Case 2
                        ...
                        FarbeR = GetTheNextGGT(FarbeR, Mod2, Mod3, Mod5)
                    ...
                    Case 5
                        ...
                        FarbeG = GetTheNextGGT(FarbeG, Mod2, Mod3, Mod5)
                    ...
                    Case 8
                        ...
                        FarbeB = GetTheNextGGT(FarbeB, Mod2, Mod3, Mod5)
                End Select
        ...
        For i = 0 To My.Computer.FileSystem.ReadAllBytes(e.Argument(1)).Length - 1
            ...
            If (i Mod 1024 = 0) Then
                Encode3.ReportProgress(i, CountBytes)
            End If
    ...
    Public Sub Encode3_ProgressChanged(ByVal sender As Object, ByVal e As System.ComponentModel.ProgressChangedEventArgs) Handles Encode3.ProgressChanged
        haupt.pgr_haupt.Maximum = e.UserState
        haupt.pgr_haupt.Value = e.ProgressPercentage
    End Sub

    Public Sub Encode3_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles Encode3.RunWorkerCompleted
