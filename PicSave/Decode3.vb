...
Module Decode3
    'Backgoundworker
    Public WithEvents Decode3 As New BackgroundWorker
    Dim Erfolg_Dec3 As Boolean = False
    Private Declare Auto Function SetProcessWorkingSetSize Lib "kernel32.dll" (ByVal procHandle As IntPtr, ByVal min As Int32, ByVal max As Int32) As Boolean


#Region "BackGroundWorker Events"
    Public Sub Decode3_DoWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles Decode3.DoWork
        Dim img As Bitmap
    ...
    Public Sub Decode3_ProgressChanged(ByVal sender As Object, ByVal e As System.ComponentModel.ProgressChangedEventArgs) Handles Decode3.ProgressChanged
        haupt.pgr_haupt.Maximum = e.UserState
        haupt.pgr_haupt.Value = e.ProgressPercentage
    End Sub

    Public Sub Decode3_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles Decode3.RunWorkerCompleted
